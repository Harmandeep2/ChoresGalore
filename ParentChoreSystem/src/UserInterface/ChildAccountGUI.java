...
private void markAsCompleted() {
	...
	else if(deadline.getDate() == currentDate.getDate() && deadline.getMonth() == currentDate.getMonth() && deadline.getYear() == currentDate.getYear()) {
		withinDeadline = true;
	}
	else if(!deadline.before(currentDate) && !currentDate.after(deadline)) {
		withinDeadline = true;
	}
	else {
